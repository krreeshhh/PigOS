...
run_command "mkdir -p /home/$SUDO_USER/.config/hypr/ && cp -r $BASE_DIR/configs/hypr/hyprland.conf /home/$SUDO_USER/.config/hypr/ && chown -R $SUDO_USER:$SUDO_USER /home/$SUDO_USER/.config/hypr/hyprland.conf" "Copy hyprland config (Must)" "yes" 
...
run_command "cp -r $BASE_DIR/configs/dunst /home/$SUDO_USER/.config/ && chown -R $SUDO_USER:$SUDO_USER /home/$SUDO_USER/.config/dunst" "Copy dunst config" "yes"
